...
static bool basicLoggerErrorTest() {
	const char* expectedFile = "unit_tests/sp_logger/basicLoggerErrorTestExp.log";
	const char* testFile = "unit_tests/sp_logger/basicLoggerErrorTest.log";
...
static bool basicLoggerDebugTest() {
	const char* expectedFile = "unit_tests/sp_logger/basicLoggerDebugTestExp.log";
	const char* testFile = "unit_tests/sp_logger/basicLoggerDebugTest.log";
