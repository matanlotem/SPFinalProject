...
int* findClosestByHand(SPPoint*** m, int numOfImages, int* numOfFeatures, int searchIndex, int kNN){
    ...
    for(int i = 0; i < numOfFeatures[searchIndex]; i++){
        ...
        for(int j = 0; j < kNN && j < numOfFeat; j++){
...
int main()
{
    ...
    printf("\nTest 6 (image 3 has less features):");
    kNN = 2;
    numOfFeatures[3] = 4;
    searchIndex = 2;
    splitMethod = MAX_SPREAD;
    ...
    printf("\nTest 7 (image 3 has less features):");
    kNN = 2;
    numOfFeatures[3] = 4;
    searchIndex = 3;
    splitMethod = MAX_SPREAD;
    ...
    printf("\nTest 8 (image 3 has less features, there are 4 images):");
    kNN = 2;
    numOfFeatures[3] = 4;
    searchIndex = 3;
    numOfImages = 4;
    ...
    printf("\nTest 9 (image 2 has 1 feature, the rest have none):");
    kNN = 2;
    numOfFeatures[0] = 0;
    numOfFeatures[1] = 0;
    numOfFeatures[2] = 1;
    ...
    printf("\nError Test 3 No features to search:");
    kNN = 2;
    searchIndex = 0;
    numOfImages = 2;
    numOfFeatures[0] = 0;
    ...
    printf("\nError Test 4 numOfClosest > numOfImages:");
    kNN = 2;
    searchIndex = 0;
    numOfImages = 2;
    splitMethod = MAX_SPREAD;
